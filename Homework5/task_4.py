...
def get_point(char):
    point_number = {
        1: set("а, в, е, ё, и, н, о, р, с, т".split(", ")),
        2: set("д, к, л, м, п, у".split(", ")),
        3: set("б, г, ь, я".split(", ")),
        4: set("й, ы".split(", ")),
        5: set("ж, з, х, ц, ч".split(", ")),
        8: set("ф, ш, э, ю".split(", ")),
        10: set("щ".split(", ")),
        15: set("ъ".split(", ")),
    }
    for point in point_number:
        if char in point_number[point]:
            return point
